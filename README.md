...
- 1.1) `git clone https://github.com/mmokrani/RNFirebase.git`
- 1.2) `cd RNFirebase` - cd into your newly created project directory.
...
#### 5) Link react-native-base

- 4.1) react-native link react-native-base
